<div class="footer">
	<div class="contacts">
		...
		<div class="socials">
			<a href="https://t.me/mam1konyan" target="_blank">
			...
			<a href="https://github.com/mam1konyan" target="_blank">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="32px" height="32px">
					<linearGradient
			...
			<a href="https://www.instagram.com/mam1konyan/" target="_blank">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="36px" height="36px">
					<radialGradient
						...
						gradientUnits="userSpaceOnUse"
					>
						<stop offset="0" stop-color="#fd5" /><stop offset=".328" stop-color="#ff543f" /><stop
							offset=".348"
							stop-color="#fc5245"
						/>
			...
			<a href="https://www.facebook.com/mam1konyan/" target="_blank">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="32px" height="32px">
					<linearGradient
